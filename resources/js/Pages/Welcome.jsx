                ...
                <div className="p-6 mx-auto max-w-7xl lg:p-8">
                    <div className="flex justify-center">
                        <svg
                            ...
                            className="w-auto h-16 bg-gray-100 dark:bg-gray-900"
                        >
                            <path
                            ...
                            <div className="">
                                {props.auth.user ? (
                                    <Link
                                        ...
                                        className="px-4 py-2 text-gray-700 border-2 rounded-lg shadow-sm hover:bg-gray-800 hover:text-gray-100 focus:outline-none"
                                    >
                                        Dashboard
                                    </Link>
                                ) : (
                                    <div className="flex flex-col-reverse gap-4">
                                        <Link
                                            href={route("login")}
                                            className="normal-case btn btn-outline"
                                        >
                                            Login
                                        </Link>
